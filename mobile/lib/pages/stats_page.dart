  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
        new Text (globals.global_name, style: new TextStyle(
                    fontWeight: FontWeight.normal,
                    fontFamily: "Rajdhani",
                    fontStyle: FontStyle.normal,
                    fontSize: 25.0)),
        ...
        new Padding(
          padding: EdgeInsets.all(15.0),
          child: new Text ("Ingredients", style: new TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: "Rajdhani",
                    fontStyle: FontStyle.normal,
                    fontSize: 15.0)),
        ...
        Expanded(
          child: SizedBox(
            ...
            child: new ListView.builder(
              ...
              itemCount: globals.getIngredients(globals.global_name).length,
              itemBuilder: (BuildContext ctxt, int index) {
                return new Center( child: Text(globals.getIngredients(globals.global_name)[index]));
                },
            ),
          ),
        ),
